    ...
    return (
        <div className="w-full flex justify-center mt-10">
            <div className="sm:w-3/4 px-10 md:p-0 flex flex-col sm:flex-row rounded-lg bg-white shadow-lg">
                <img className="w-full h-4/5 sm:h-52 object-cover sm:w-1/2 md:w-1/3 rounded-t-lg md:rounded-none md:rounded-l-lg" src="https://media.architecturaldigest.com/photos/60e33c2983afe4fd18137304/master/w_2500,h_1669,c_limit/rosemarys_0421_lizclayman_211.jpg" alt="" />
