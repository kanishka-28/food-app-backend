        ...
        <div class="block md:flex shadow-md my-10">
          <div class= " w-full md:w-3/4 bg-white px-10 py-10">
            ...
            <p
              ...
              class="flex font-semibold text-zomato-500 text-sm mt-10 cursor-pointer"
            >
              <svg
                class="fill-current mr-2 text-zomato-400 w-4"
                viewBox="0 0 448 512"
              >
          ...
          <div id="summary" class="w-full md:w-1/4 px-8 py-10">
            ...
            <button class="bg-zomato-400 hover:bg-zomato-500 px-5 py-2 text-sm text-white uppercase">
              Apply
            </button>
            <div class="border-t mt-8">
              ...
              <button class="bg-zomato-400 font-semibold hover:bg-zomato-500 py-3 text-sm text-white uppercase w-full">
                Checkout
              </button>
            </div>
          </div>
