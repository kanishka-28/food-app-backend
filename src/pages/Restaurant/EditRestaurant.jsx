        ...
        <div className="mt-5 md:mt-0 md:col-span-2">
          <form onSubmit={handleSave}>
              ...
              <div className="sm:w-1/3 h-96 px-4 bg-white space-y-3 sm:p-6">
                ...
                <div className="justify-center h-3/4 sm:h-full focus:border-none focus:outline-none focus:ring-1 focus:ring-black border border-gray-300 rounded mt-1 flex items-center">
                  <img
                    ...
                    alt="Not Found"
                    className={`${
                      restaurantDetails.image ? "w-full" : "w-1/2"
                    } h-full`}
                  />
                </div>
            ...
            <div className="flex justify-center px-4 py-1 bg-gray-50 text-right sm:px-6">
              <button className="text-center inline-flex self-center justify-center py-2 px-8 border border-transparent shadow-sm font-medium rounded text-white bg-zomato-400 hover:bg-zomato-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-zomato-500 hover:scale-110 ease-in duration-200">
                Save
              </button>
            </div>
          </form>
