...
const MdTab = () => {
    ...
    const [allTypes] = useState([
        {
            id: `delivery`,
            icon: <MdOutlineDeliveryDining fontSize="2rem" />,
            name: "Restaurant",
            isActive: false
        },
        {
            id: `kitchen`,
            icon: <SiCodechef fontSize="2rem" />,
            name: "Home Kitchen",
            isActive: false
        },
        // {
    ...
    return (
        <div className="hidden md:flex bg-white border-b px-8 pt-3 flex items-start gap-16  z-10 w-full text-gray-500">
            {
                allTypes.map((item) => {
                    return (
                        <Link key={item.id} to={`/home/${item.id}`}>
                            ...
                            <div className={
                                ...
                                <span className={item.isActive ? "rounded-full p-2" : "bg-white p-2"}>
