...
const AboutUser = ({profile,setedit}) => {
  return (
    <>
    <h1 className="text-3xl font-bold pt-8 lg:pt-0">{profile?.userName ? capitalize(profile?.userName) : 'No name provided'}</h1>
    ...
    <div className="flex flex-col md:flex-row justify-between items-center">
      ...
      {profile?.city ? `city : ${capitalize(profile.city)} `: 'No city available' }
    </p>
