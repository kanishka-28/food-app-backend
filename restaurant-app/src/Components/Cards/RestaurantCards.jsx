        ...
        <div className="w-full flex justify-center mt-10 ">
            <div className="sm:w-full md:w-3/4 px-10 md:p-0 flex flex-col sm:flex-row rounded-lg bg-white shadow-lg justify-between relative">
                <Link to={`/restaurant/${restaurant._id}`}>
                    <img className="cursor-pointer w-full h-40 sm:h-52 object-cover sm:w-40 md:w-64 rounded-t-lg md:rounded-none md:rounded-l-lg" src={restaurant?.coverImage ? restaurant?.coverImage : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSiCuem-at-uRZQ5ft4t24y4-Y7WYTnRHdVjA&usqp=CAU'} alt="" />
                </Link>
